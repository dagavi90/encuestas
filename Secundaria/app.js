...
if(window.localStorage.getItem("registros")==null){
	...
	function getDatosRadios(){
		...
		txt+=document.getElementById("final").value+" ;\n"	
	...
	txta.placeholder="31.	Tu opinión es importante, por ello en este espacio, escribe breve y concretamente, las causas que frecuentemente afecta la sana convivencia escolar:";
	txta.id="final"
	document.getElementById("form").appendChild(txta);
